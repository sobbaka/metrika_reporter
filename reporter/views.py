...
from reporter.forms import ProjectForm, ProjectCreateForm
from reporter.models import Project, Link
from reporter.utils import (
    get_data_and_dates_metrika,
    write_csv,
    export_to_gspread,
    delete_file_gspread,
    share_file_gspread
...
class ProjectEdit(LoginRequiredMixin, UpdateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        project.counter = request.POST['counter']
        project.token = request.POST['token']
        project.save()
